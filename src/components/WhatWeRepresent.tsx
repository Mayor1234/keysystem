        ...
        <div className="text-[#ffffff] text-center mb-10 self-center">
          ...
          <AnimateSections delay={0.5} type="popUp">
            <p className="font-popppins font-normal text-[#D2D2D2] text-center text-lg lg:text-[24px] mb-5">
              ...
              exellence is the driving force <br /> behind our success.
              Exellence is our legacy, and we are proud to carry it forward.
              Watch <br /> the video to see how we are innovating to keep
              businesses on top of thier games.
            </p>
          </AnimateSections>
        </div>
        <VisionMission />
