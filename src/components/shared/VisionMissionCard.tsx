...
const VisionMissionCard: React.FC<CardProps> = ({
  ...
  return (
    <div className="w-full max-w-[625px] h-full md:h-[700px] mx-auto rounded-xl bg-gradient-to-b from-[#01B4DE] via-[#030517] to-[#01B4DE] p-px shadow-lg hover:shadow-[0_0_25px_#00c2ff55] transition-all duration-300 relative overflow-hidden">
